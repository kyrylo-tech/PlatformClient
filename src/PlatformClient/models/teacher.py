...
class TeacherMethods(BaseMethods):
    ...
    async def GetDetails(self, branch_id: SafeUUID | str, teacher_id: SafeUUID | str) -> HTTPResponse:
        """
        ...
        return await self.client.send_request(
            ...
            { "CompanyBranchId": str(branch_id), "teacherId": str(teacher_id) }
        )
...
class TeacherClass(BaseClass[TeacherMethods]):
    ...
    def __init__(self, client: "PlatformClient", branch_id: SafeUUID | str, teacher_id: SafeUUID | str):
